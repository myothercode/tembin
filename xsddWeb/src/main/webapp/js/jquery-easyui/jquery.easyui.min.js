...
},plugins:["draggablex","droppable","resizablex","pagination","tooltipx","linkbutton","menu","menubutton","splitbutton","progressbar","tree","combobox","combotree","combogrid","numberbox","validatebox","searchbox","numberspinner","timespinner","calendar","datebox","datetimebox","slider","layout","panel","datagrid","propertygrid","treegrid","tabs","accordion","window","dialog"],parse:function(_2){
var aa=[];
...
_15(e,"mousedown");
if($.fn.draggablex.isDragging||$.fn.resizablex.isResizing){
e.preventDefault();
}
};
function _16(e){
...
(function($){
function _1b(e){
var _1c=$.data(e.data.target,"draggablex");
var _1d=_1c.options;
var _1e=_1c.proxy;
var _1f=e.data;
...
function _21(e){
var _22=$.data(e.data.target,"draggablex");
var _23=_22.options;
var _24=_22.proxy;
if(!_24){
_24=$(e.data.target);
...
function _25(e){
$.fn.draggablex.isDragging=true;
var _26=$.data(e.data.target,"draggablex");
var _27=_26.options;
...
function _2b(e){
var _2c=$.data(e.data.target,"draggablex");
_1b(e);
...
function _2f(e){
$.fn.draggablex.isDragging=false;
_2b(e);
var _30=$.data(e.data.target,"draggablex");
var _31=_30.proxy;
var _32=_30.options;
if(_32.revert){
if(_33()==true){
...
$.fn.draggablex=function(_38,_39){
if(typeof _38=="string"){
return $.fn.draggablex.methods[_38](this,_39);
}
return this.each(function(){
var _3a;
var _3b=$.data(this,"draggablex");
if(_3b){
_3b.handle.unbind(".draggablex");
_3a=$.extend(_3b.options,_38);
}else{
_3a=$.extend({},$.fn.draggablex.defaults,$.fn.draggablex.parseOptions(this),_38||{});
}
var _3c=_3a.handle?(typeof _3a.handle=="string"?$(_3a.handle,this):_3a.handle):$(this);
$.data(this,"draggablex",{options:_3a,handle:_3c});
if(_3a.disabled){
$(this).css("cursor","");
return;
}
_3c.unbind(".draggablex").bind("mousemove.draggablex",{target:this},function(e){
if($.fn.draggablex.isDragging){
return;
}
var _3d=$.data(e.data.target,"draggablex").options;
if(_3e(e)){
$(this).css("cursor",_3d.cursor);
}else{
$(this).css("cursor","");
}
}).bind("mouseleave.draggablex",{target:this},function(e){
$(this).css("cursor","");
}).bind("mousedown.draggablex",{target:this},function(e){
if(_3e(e)==false){
return;
}
$(this).css("cursor","");
...
$.extend(e.data,_41);
var _42=$.data(e.data.target,"draggablex").options;
if(_42.onBeforeDrag.call(e.data.target,e)==false){
return;
}
$(document).bind("mousedown.draggablex",e.data,_25);
$(document).bind("mousemove.draggablex",e.data,_2b);
$(document).bind("mouseup.draggablex",e.data,_2f);
});
function _3e(e){
var _43=$.data(e.data.target,"draggablex");
var _44=_43.handle;
var _45=$(_44).offset();
...
$.fn.draggablex.methods={options:function(jq){
return $.data(jq[0],"draggablex").options;
},proxy:function(jq){
return $.data(jq[0],"draggablex").proxy;
},enable:function(jq){
return jq.each(function(){
$(this).draggablex({disabled:false});
});
},disable:function(jq){
return jq.each(function(){
$(this).draggablex({disabled:true});
});
}};
$.fn.draggablex.parseOptions=function(_48){
var t=$(_48);
...
$.fn.draggablex.defaults={proxy:null,revert:false,cursor:"move",deltaX:null,deltaY:null,handle:null,disabled:false,edge:0,axis:null,onBeforeDrag:function(e){
...
(function($){
$.fn.resizablex=function(_57,_58){
if(typeof _57=="string"){
return $.fn.resizablex.methods[_57](this,_58);
}
function _59(e){
var _5a=e.data;
var _5b=$.data(_5a.target,"resizablex").options;
...
function _60(e){
$.fn.resizablex.isResizing=true;
$.data(e.data.target,"resizablex").options.onStartResize.call(e.data.target,e);
return false;
};
function _61(e){
_59(e);
if($.data(e.data.target,"resizablex").options.onResize.call(e.data.target,e)!=false){
_5e(e);
}
return false;
};
function _62(e){
$.fn.resizablex.isResizing=false;
_59(e,true);
_5e(e);
$.data(e.data.target,"resizablex").options.onStopResize.call(e.data.target,e);
$(document).unbind(".resizablex");
$("body").css("cursor","");
return false;
};
return this.each(function(){
var _63=null;
var _64=$.data(this,"resizablex");
if(_64){
$(this).unbind(".resizablex");
_63=$.extend(_64.options,_57||{});
}else{
_63=$.extend({},$.fn.resizablex.defaults,$.fn.resizablex.parseOptions(this),_57||{});
$.data(this,"resizablex",{options:_63});
}
if(_63.disabled==true){
return;
}
$(this).bind("mousemove.resizablex",{target:this},function(e){
if($.fn.resizablex.isResizing){
return;
}
var dir=_65(e);
if(dir==""){
...
}).bind("mouseleave.resizablex",{target:this},function(e){
$(e.data.target).css("cursor","");
}).bind("mousedown.resizablex",{target:this},function(e){
var dir=_65(e);
if(dir==""){
return;
}
...
$(document).bind("mousedown.resizablex",_67,_60);
$(document).bind("mousemove.resizablex",_67,_61);
$(document).bind("mouseup.resizablex",_67,_62);
...
$.fn.resizablex.methods={options:function(jq){
return $.data(jq[0],"resizablex").options;
},enable:function(jq){
return jq.each(function(){
$(this).resizablex({disabled:false});
});
},disable:function(jq){
return jq.each(function(){
$(this).resizablex({disabled:true});
});
}};
$.fn.resizablex.parseOptions=function(_6e){
var t=$(_6e);
...
$.fn.resizablex.defaults={disabled:false,handles:"n, e, s, w, ne, se, sw, nw, all",minWidth:10,minHeight:10,maxWidth:10000,maxHeight:10000,edge:5,onStartResize:function(e){
},onResize:function(e){
...
var _c8=_c6.tree;
_c6.disabledNodes=[];
_c8.find("div.tree-node").draggablex({disabled:false,revert:true,cursor:"pointer",proxy:function(_c9){
...
$(this).draggablex("proxy").css({left:-10000,top:-10000});
...
var _db=$(_d9).draggablex("proxy").find("span.tree-dnd-icon");
...
(function($){
function init(_1b1){
$(_1b1).addClass("tooltipx-f");
};
function _1b2(_1b3){
var opts=$.data(_1b3,"tooltipx").options;
$(_1b3).unbind(".tooltipx").bind(opts.showEvent+".tooltipx",function(e){
_1ba(_1b3,e);
}).bind(opts.hideEvent+".tooltipx",function(e){
_1c0(_1b3,e);
}).bind("mousemove.tooltipx",function(e){
if(opts.trackMouse){
...
var _1bc=$.data(_1bb,"tooltipx");
var opts=_1bc.options;
var tip=_1bc.tip;
if(!tip){
tip=$("<div tabindex=\"-1\" class=\"tooltipx\">"+"<div class=\"tooltipx-content\"></div>"+"<div class=\"tooltipx-arrow-outer\"></div>"+"<div class=\"tooltipx-arrow\"></div>"+"</div>").appendTo("body");
_1bc.tip=tip;
_1bd(_1bb);
}
tip.removeClass("tooltipx-top tooltipx-bottom tooltipx-left tooltipx-right").addClass("tooltipx-"+opts.position);
_1b5(_1bb);
_1bc.showTimer=setTimeout(function(){
_1b4(_1bb);
tip.show();
opts.onShow.call(_1bb,e);
var _1be=tip.children(".tooltipx-arrow-outer");
var _1bf=tip.children(".tooltipx-arrow");
...
_1c5.tip.children(".tooltipx-content").html(cc);
opts.onUpdate.call(_1c3,cc);
};
function _1c6(_1c7){
var _1c8=$.data(_1c7,"tooltipx");
if(_1c8){
_1b5(_1c7);
...
$.removeData(_1c7,"tooltipx");
$(_1c7).unbind(".tooltipx").removeClass("tooltipx-f");
opts.onDestroy.call(_1c7);
}
};
$.fn.tooltipx=function(_1c9,_1ca){
if(typeof _1c9=="string"){
return $.fn.tooltipx.methods[_1c9](this,_1ca);
}
_1c9=_1c9||{};
return this.each(function(){
var _1cb=$.data(this,"tooltipx");
if(_1cb){
$.extend(_1cb.options,_1c9);
}else{
$.data(this,"tooltipx",{options:$.extend({},$.fn.tooltipx.defaults,$.fn.tooltipx.parseOptions(this),_1c9)});
init(this);
}
_1b2(this);
_1bd(this);
...
$.fn.tooltipx.methods={options:function(jq){
return $.data(jq[0],"tooltipx").options;
},tip:function(jq){
return $.data(jq[0],"tooltipx").tip;
},arrow:function(jq){
return jq.tooltipx("tip").children(".tooltipx-arrow-outer,.tooltipx-arrow");
},show:function(jq,e){
return jq.each(function(){
_1ba(this,e);
});
...
$.fn.tooltipx.parseOptions=function(_1cd){
var t=$(_1cd);
...
$.fn.tooltipx.defaults={position:"bottom",content:null,trackMouse:false,deltaX:0,deltaY:0,showEvent:"mouseenter",hideEvent:"mouseleave",showDelay:200,hideDelay:100,onShow:function(e){
},onHide:function(e){
...
t.find(".tooltipx-f").tooltipx("destroy");
};
function _1e9(_1ea){
...
_23b.window.draggablex({handle:">div.panel-header>div.panel-title",disabled:_23b.options.draggablex==false,onStartDrag:function(e){
if(_23b.mask){
...
_23b.window.resizablex({disabled:_23b.options.resizablex==false,onStartResize:function(e){
...
return $.extend({},$.fn.panel.parseOptions(_244),$.parser.parseOptions(_244,[{draggablex:"boolean",resizablex:"boolean",shadow:"boolean",modal:"boolean",inline:"boolean"}]));
};
$.fn.window.defaults=$.extend({},$.fn.panel.defaults,{zIndex:9000,draggablex:true,resizablex:true,shadow:true,modal:false,inline:false,title:"New Window",collapsible:true,minimizable:true,maximizable:true,closable:true,closed:false});
})(jQuery);
(function($){
function _245(_246){
...
$.fn.dialog.defaults=$.extend({},$.fn.window.defaults,{title:"New Dialog",collapsible:false,minimizable:false,maximizable:false,resizablex:false,toolbar:null,buttons:null});
})(jQuery);
(function($){
...
function _262(_263){
var opts=$.extend({},$.fn.window.defaults,{collapsible:false,minimizable:false,maximizable:false,shadow:false,draggablex:false,resizablex:false,closed:true,style:{left:"",top:"",right:0,zIndex:$.fn.window.defaults.zIndex++,bottom:-document.body.scrollTop-document.documentElement.scrollTop},onBeforeOpen:function(){
...
win.window({title:_265,noheader:(_265?false:true),width:300,height:"auto",modal:true,collapsible:false,minimizable:false,maximizable:false,resizablex:false,onClose:function(){
setTimeout(function(){
win.window("destroy");
},100);
}});
...
_348.resizablex($.extend({},{handles:_349,onStartResize:function(e){
_32e=true;
...
$(_3f0).tooltipx($.extend({},opts.tipOptions,{content:_3f1.message,position:opts.tipPosition,deltaX:opts.deltaX})).tooltipx("show");
_3f1.tip=true;
};
function _3f2(_3f3){
var _3f4=$.data(_3f3,"validatebox");
if(_3f4&&_3f4.tip){
$(_3f3).tooltipx("reposition");
}
};
function _3ee(_3f5){
...
$(this).tooltipx("tip").css({color:"#000",borderColor:"#CC9933",backgroundColor:"#FFFFCC"});
},onHide:function(){
$(this).tooltipx("destroy");
...
if(col.resizablex==false){
cell.attr("resizablex","false");
}
if(col.width){
...
_505.each(function(){
$(this).resizablex({handles:_50d,disabled:($(this).attr("resizablex")?$(this).attr("resizablex")=="false":false),minWidth:25,onStartResize:function(e){
_502.resizing=true;
...
$.fn.propertygrid.defaults=$.extend({},$.fn.datagrid.defaults,{singleSelect:true,remoteSort:false,fitColumns:true,loadMsg:"",frozenColumns:[[{field:"f",width:16,resizablex:false}]],columns:[[{field:"name",title:"Name",width:100,sortable:true},{field:"value",title:"Value",width:100,resizablex:false}]],showGroup:false,groupField:"group",groupFormatter:function(_6ec,rows){
return _6ec;
}});
})(jQuery);
(function($){
...
_8e0.find("a.slider-handle").draggablex({axis:opts.mode,cursor:"pointer",disabled:opts.disabled,onDrag:function(e){
