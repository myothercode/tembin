        ...
        function makeOption1(json){
            ...
            if(tr1.length>0){
                ...
                var tr="<tr name='competitorTr' id='competitorTr"+json.id+"'><td><input type='hidden' name='competitorHidden'value='"+json.id+"'></td><td valign='top'><label  class='control-label' style='line-height: 30px;' >竞争对手:</label></td>" +
                        ...
                        "<table><tr><td style='width: 300px;'>价格始终<select name='competitorPrice"+json.id+"'><option value='0'>竞争对手价格</option><option value='1'>低于竞争对手</option><option value='2'>高于竞争对手</option></select><select name='competitorPriceAdd"+json.id+"'><option value='1'>-</option><option  value='2'>+</option></select><input name='competitorPriceInput"+json.id+"'  style='width: 50px;margin-left: 5px;margin-right: 5px; '/><select name='competitorPriceSymbol"+json.id+"'><option value='1'>$</option><option value='2'>%</option></select></td></tr>" +
                        "<tr><td style='width: 300px;'>排名始终<select name='competitorRanking"+json.id+"'><option value='0'>竞争对手排名</option><option value='1'>低于竞争对手</option><option value='2'>高于竞争对手</option></select><select name='competitorRankingAdd"+json.id+"'><option value='1'>-</option><option value='2'>+</option></select><input name='competitorRankingInput"+json.id+"' style='width: 50px;margin-left: 5px;margin-right: 5px; '/><select name='competitorRankingSymbol"+json.id+"'><option value='1'>$</option><option value='2'>%</option></select></td></tr></table></td>" +
                        "</tr>";
