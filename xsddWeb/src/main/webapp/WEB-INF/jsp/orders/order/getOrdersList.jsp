    ...
    <div class="new_usa" style="margin-top:20px;">
        ...
        <li class="new_usa_list"><span class="newusa_i" style="width: 75px;">选择账号：</span>
            ...
            <c:forEach items="${ebays}" var="ebay" begin="0" varStatus="status">
                <a href="javascript:void(0)"><span scop="account1" onclick="selectAccount1(1,${status.index+2},'${ebay.ebayName}');" class="newusa_ici_1">${ebay.ebayNameCode}</span></a>
            </c:forEach>
         </li>
...
<div style="display: none;" id="con_menu_2">
    ...
    <div class="new_usa" style="margin-top:20px;">
        ...
        <li class="new_usa_list"><span class="newusa_i" style="width: 75px;">选择账号：</span>
            ...
            <c:forEach items="${ebays}" var="ebay" begin="0" varStatus="status">
                <a href="javascript:void(0)"><span scop="account2" onclick="selectAccount1(2,${status.index+2},'${ebay.ebayName}');" class="newusa_ici_1">${ebay.ebayNameCode}</span></a>
            </c:forEach>
        </li>
...
<div style="display: none;" id="con_menu_3">
    ...
    <div class="new_usa" style="margin-top:20px;">
        ...
        <li class="new_usa_list"><span class="newusa_i" style="width: 75px;">选择账号：</span>
            ...
            <c:forEach items="${ebays}" var="ebay" begin="0" varStatus="status">
                <a href="javascript:void(0)"><span scop="account3" onclick="selectAccount1(3,${status.index+2},'${ebay.ebayName}');" class="newusa_ici_1">${ebay.ebayNameCode}</span></a>
            </c:forEach>
        </li>
...
<div style="display: none;" id="con_menu_4">
    ...
    <div class="new_usa" style="margin-top:20px;">
        ...
        <li class="new_usa_list"><span class="newusa_i" style="width: 75px;">选择账号：</span>
            ...
            <c:forEach items="${ebays}" var="ebay" begin="0" varStatus="status">
                <a href="javascript:void(0)"><span scop="account4" onclick="selectAccount1(4,${status.index+2},'${ebay.ebayName}');" class="newusa_ici_1" name1="${ebay.ebayName}">${ebay.ebayNameCode}</span></a>
            </c:forEach>
        </li>
...
<div style="display: none;" id="con_menu_5">
    ...
    <div class="new_usa" style="margin-top:20px;">
        ...
        <li class="new_usa_list"><span class="newusa_i" style="width: 75px;">选择账号：</span>
            ...
            <c:forEach items="${ebays}" var="ebay" begin="0" varStatus="status">
                <a href="javascript:void(0)"><span scop="account5" onclick="selectAccount1(5,${status.index+2},'${ebay.ebayName}');" class="newusa_ici_1">${ebay.ebayNameCode}</span></a>
            </c:forEach>
        </li>
        ...
        <div class="newsearch">
            ...
            <%--<span style="float: left;color: #5F93D7;">从</span><input class="form-controlsd " style="float: left;color: #5F93D7;width: 90px;height: 26px;border-color: #d0dde9" id="starttime3"  type="text" onfocus="WdatePicker({isShowWeek:true,dateFmt:'yyyy-MM-dd'})"/>
            <span style="float: left;color: #5F93D7;">到</span><input class="form-controlsd " style="float: left;color: #5F93D7;width: 90px;height: 26px;margin-right: 20px;border-color: #d0dde9" id="endtime3"  type="text" onfocus="WdatePicker({isShowWeek:true,dateFmt:'yyyy-MM-dd'})"/>--%>
            <a href="javascript:void(0)" onclick="addstartTimeAndEndTime(this,5)"><span scop="queryTime5" onclick="queryTime(5,6,null)" class="newusa_ici_1">自定义&nbsp;</span></a><span style="float: left" id="time3"></span>
        </div>
        ...
        <div class="newsearch">
            ...
            <span id="sleBG">
<span id="sleHid">
<select name="type" class="select" id="itemType5" onchange="cleanInput();">
    <option selected="selected" >选择类型</option>
    <option value="buyerId">买家账号</option>
    <option value="itemId">物品号</option>
    <option value="sku">SKU</option>
    ...
    <option value="transaction">EBAY交易号</option>
            ...
            <div class="vsearch">
                <input id="content5" name="" type="text"  class="key_1"><input name="newbut" onclick="query5();" type="button" class="key_2"></div>
        </div>
        <div class="newds">
            <div class="newsj_left">
