...
public class SynchronizeGetTimerOrdersTaskRun extends BaseScheduledClass implements Scheduledable {
    ...
    public void synchronizeOrders(List<TaskGetOrders> taskGetOrders){
        ...
        ITradingOrderGetItem iTradingOrderGetItem=(ITradingOrderGetItem) ApplicationContextUtil.getBean(ITradingOrderGetItem.class);
        ITradingOrderSeller iTradingOrderSeller=(ITradingOrderSeller) ApplicationContextUtil.getBean(ITradingOrderSeller.class);
        ITradingOrderShippingDetails iTradingOrderShippingDetails=(ITradingOrderShippingDetails)ApplicationContextUtil.getBean(ITradingOrderShippingDetails.class);
        ITradingOrderCalculatedShippingRate iTradingOrderCalculatedShippingRate=(ITradingOrderCalculatedShippingRate)ApplicationContextUtil.getBean(ITradingOrderCalculatedShippingRate.class);
        ITradingOrderSellerInformation iTradingOrderSellerInformation=(ITradingOrderSellerInformation)ApplicationContextUtil.getBean(ITradingOrderSellerInformation.class);
        ITradingOrderSellingStatus iTradingOrderSellingStatus=(ITradingOrderSellingStatus) ApplicationContextUtil.getBean(ITradingOrderSellingStatus.class);
        ITradingOrderReturnpolicy iTradingOrderReturnpolicy=(ITradingOrderReturnpolicy) ApplicationContextUtil.getBean(ITradingOrderReturnpolicy.class);
        ITradingOrderShippingServiceOptions iTradingOrderShippingServiceOptions=(ITradingOrderShippingServiceOptions)ApplicationContextUtil.getBean(ITradingOrderShippingServiceOptions.class);
        ITradingOrderItemSpecifics iTradingOrderItemSpecifics=(ITradingOrderItemSpecifics)ApplicationContextUtil.getBean(ITradingOrderItemSpecifics.class);
        ITradingOrderVariation iTradingOrderVariation=(ITradingOrderVariation)ApplicationContextUtil.getBean(ITradingOrderVariation.class);
        ITradingOrderVariationSpecifics iTradingOrderVariationSpecifics=(ITradingOrderVariationSpecifics)ApplicationContextUtil.getBean(ITradingOrderVariationSpecifics.class);
        ITradingOrderPictures iTradingOrderPictures=(ITradingOrderPictures)ApplicationContextUtil.getBean(ITradingOrderPictures.class);
        ITradingOrderListingDetails iTradingOrderListingDetails=(ITradingOrderListingDetails)ApplicationContextUtil.getBean(ITradingOrderListingDetails.class);
        ITradingOrderPictureDetails iTradingOrderPictureDetails=(ITradingOrderPictureDetails) ApplicationContextUtil.getBean(ITradingOrderPictureDetails.class);
        ITradingOrderGetAccount iTradingOrderGetAccount=(ITradingOrderGetAccount)ApplicationContextUtil.getBean(ITradingOrderGetAccount.class);
