...
public interface TradingMessageAddmembermessageMapper {
     ...
     * @mbggenerated
     */
    List<TradingMessageAddmembermessage> selectByExampleWithBLOBs(TradingMessageAddmembermessageExample example);
     ...
     * @mbggenerated
     */
    int updateByExampleWithBLOBs(@Param("record") TradingMessageAddmembermessage record, @Param("example") TradingMessageAddmembermessageExample example);
     ...
     * @mbggenerated
     */
    int updateByPrimaryKeyWithBLOBs(TradingMessageAddmembermessage record);
